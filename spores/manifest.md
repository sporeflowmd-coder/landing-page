...
in the future it will allow multi biomass coordination in what is called the SporeHub (currently under development)

## 🛠️ Tech Stack / Tools
- Primary Medium: static HTML
- Deployment Target / Outcome: static webpage serve
...
- /spores/_food/substrate.md
- /spores/protocol/charms.md
